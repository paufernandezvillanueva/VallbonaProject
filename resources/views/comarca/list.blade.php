...
@section('content')
<div class="titulo">
    <h1>{{ trans('translation.list_comarca') }}</h1>
</div>
...
<div id="filter">
    ...
    <form id="filter-form" class="filter-form filter-form-closed-base" method="post" style="max-height: 0px;" action="{{ route('comarca_list') }}">
        @csrf
    ...
    <table id="comarca-table" class="table table-striped table-dark">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a data-id="{{ $comarca->id }}" data-name="{{ $comarca->name }}" class="iconBasura" data-bs-toggle="modal" data-bs-target="#confirmDelete">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="novaComarcaLabel">{{ trans('translation.create').' '. trans('translation.comarca') }}</h5>
...
<div class="modal fade" id="confirmDelete" tabindex="-1" aria-labelledby="confirmDeleteLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmDeleteLabel">{{ trans('translation.delete').' '.trans('translation.comarca') }}</h5>
                <button type="button" data-bs-dismiss="modal" aria-label="Close"><i class="bi bi-x-lg"></i></button>
            </div>
            <form method="GET">
                <div class="modal-body">
...
<div class="modal fade" id="importComarques" tabindex="-1" aria-labelledby="importComarquesLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="importComarquesLabel">{{ trans('translation.import_csv') }}</h5>
