...
<div id="filter">
    ...
    <form id="filter-form" class="filter-form filter-form-closed-base" method="post" style="max-height: 0px;" action="{{ route('curs_list') }}">
        @csrf
    ...
    <table id="curs-table" class="table table-striped table-dark">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a data-id="{{ $curs->id }}" data-name="{{ $curs->name }}" class="iconBasura" data-bs-toggle="modal" data-bs-target="#confirmDelete">
...
<div class="modal fade" id="importCursos" tabindex="-1" aria-labelledby="importCursosLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="importCursosLabel">{{ trans('translation.import_csv') }}</h5>
