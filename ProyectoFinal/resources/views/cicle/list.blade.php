...
<div id="filter">
    ...
    <form id="filter-form" class="filter-form filter-form-closed-base" method="post" style="max-height: 0px;" action="{{ route('cicle_list') }}">
        @csrf
...
<div class="modal fade" id="importCicles" tabindex="-1" aria-labelledby="importCiclesLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="importCiclesLabel">{{ trans('translation.import_csv') }}</h5>
